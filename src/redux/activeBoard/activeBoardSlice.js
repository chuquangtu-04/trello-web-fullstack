...
export const { updateCurrentActiveBoard, updateCardInBoard, setBoardCreationDraft, updateFilters, addLabelToBoard, updateLabelInBoard, removeLabelFromBoard } = activeBoardSlice.actions
